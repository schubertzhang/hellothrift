...
public class HelloServer {
    public static void main(String[] args) throws Exception {
        ...
        if (serverType.equalsIgnoreCase("threadedselector")) {
            ...
            // Simple one thread server, only server one connect at a time. Just for test.
            System.out.println("Server type: TSimpleServer.");
            System.out.println("simple one thread server, only server one connect at a time. Just for test.");
